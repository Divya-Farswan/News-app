    ...
    <nav className="navbar fixed-top navbar-expand-lg bg-dark border-bottom border-body bg-body-tertiary" data-bs-theme="dark">
      <div className="container-fluid px-3">
        <a className="navbar-brand d-flex align-items-center" href="#">
          <span className="badge bg-primary text-light fs-2 px-4" style={{ cursor: "pointer" }} onClick={() => {
            setCategory("general");
            setSearchText("");
            setQuery("");
          }} >NEWS</span>
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav no-blink-cursor justify-content-end gap-2 me-5 mb-lg-0 mb-4 flex-grow-1">
              <li className="nav-item">
                ...
                } className="nav-link custom-line">Technology</div>
              </li>
              <li className="nav-item">
                <div onClick={() => {
                  setCategory("business"); setSearchText("");
                  setQuery("");
                }} className="nav-link custom-line">Business</div>
              </li>
              <li className="nav-item">
                <div onClick={() => {
                  setCategory("health");
                ...
                } className="nav-link custom-line">Health</div>
              </li>
              <li className="nav-item">
                <div onClick={() => {
                  setCategory("sports");
                ...
                } className="nav-link custom-line">Sports</div>
              </li>
              <li className="nav-item">
                <div onClick={() => {
                ...
                } className="nav-link custom-line">Entertainment</div>
              </li>
            </ul>
